    ...
    <div className="dark:bg-gray-800 transition duration-500">
      <div id="home" className="flex flex-col md:flex-row justify-center md:justify-around gap-y-10 items-center md:h-[95vh]">
        <div data-aos="zoom-in" className="w-100 order-last md:order-first">
          ...
          <h2 className="mb-4 text-center md:text-left text-5xl text-gray-500 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-700 transition-colors duration-500 font-Finger-Paint">Omar Ragheb</h2>
          <p className="text-center md:text-left text-purple-700 dark:text-purple-600 text-2xl font-Raleway mb-6">
            <Typed
              strings={['I\'m a Full-Stack developer', 'I\'m a front-end developer', 'I\'m a web developer']}
              typeSpeed={80}
              backSpeed={80}
              loop
            />
          ...
          <div className="flex items-center justify-center md:justify-start">
            <a href="mailto:ahmed.raph29@gmail.com" target="_blank" rel="noreferrer" className="mr-6">
            ...
            <a href="https://github.com/omar25ahmed" target="_blank" rel="noreferrer" className="mr-6">
            ...
            <a href="https://www.linkedin.com/in/omar-ragheb/" target="_blank" rel="noreferrer" className="mr-6">
            ...
            <a href="https://twitter.com/omar25ahmed" target="_blank" rel="noreferrer">
